I am Weilin Du (LamentXU), a 17 years old senior high school student in Hong Kong, China. I write Python, PHP, C#, C++, C, Java and Visual Basic. Mostly PHP and C(++), and recently Python and Java. I enjoy "writing" codes, and therefore I rarely use LLMs.
...
- [LamentXU123/secured_pip](https://github.com/LamentXU/secured_pip): A defensive pip wrapper with supply-chain preflight checks. ![Total Downloads](https://static.pepy.tech/personalized-badge/secured-pip?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)
